...
var VIVA_CONNECTIONS_1P_APPID = 'sharepointportal_d2c6f111-ffad-42a0-b65e-ee00425598aa';
/**
 * Qos logger
...
var QosMonitor = /** @class */ (function () {
    ...
    QosMonitor.prototype._logHostType = function () {
        var _a;
        if (!(0, Killswitches_1.isAddHostTypeKSActivated)() && DiagnosticsSettingsManager_1.default.isInitialized) {
            var appHostType = void 0;
            if ((_a = DiagnosticsSettingsManager_1.default.settings.contextInfo) === null || _a === void 0 ? void 0 : _a.isEduClass) {
                appHostType = 'TeamsEdu';
            }
            else if (this._isViva1pApp()) {
                appHostType = 'viva1p';
            }
            else if (sp_core_library_1._BrowserUtilities.isTeamsHosted()) {
                appHostType = 'TeamsCommercial';
            }
    ...
    QosMonitor.prototype._writeToEngagement = function () {
        if (!(0, Killswitches_1.isLogToInteranaKSActivated)() && this._copyToInterana) {
    ...
    QosMonitor.prototype._isViva1pApp = function () {
        if ((0, Killswitches_1.isViva1QoSKillSwitchActivated)()) {
            return false;
        }
        try {
            return ((sessionStorage === null || sessionStorage === void 0 ? void 0 : sessionStorage.getItem('TeamsAppType')) === 'VivaConnections' ||
                (localStorage === null || localStorage === void 0 ? void 0 : localStorage.getItem('TeamsAppEntityId')) === VIVA_CONNECTIONS_1P_APPID ||
                (localStorage === null || localStorage === void 0 ? void 0 : localStorage.getItem('hostedApp')) === 'viva1p');
        }
        catch (_a) {
            return false;
        }
