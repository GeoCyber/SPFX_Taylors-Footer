...
var strings = tslib_1.__importStar(require("./ExtensionStrings.resx"));
/**
...
var ExtensionManager = /** @class */ (function () {
    ...
    ExtensionManager.prototype.createExtension = function (componentId, propertiesJson, contextCreator) {
        var _this = this;
        var qosMonitor = new sp_diagnostics_1._QosMonitor('Extension.Create', true);
        var manifest = sp_loader_1.SPComponentLoader.tryGetManifestById(componentId);
        if (!manifest) {
            var manifestError = new Error(sp_core_library_1.Text.format(strings.manifestNotFound, componentId));
        ...
        try {
            ...
            var createPromise = sp_loader_1.SPComponentLoader.loadComponent(manifest)
                .then(function (component) {
                sp_telemetry_1._PerformanceLogger.endMarkForComponent(perfLogKeyScriptLoad_1);
                sp_telemetry_1._PerformanceLogger.logPerformanceMetricToConsole(perfLogKeyScriptLoad_1, 'Extension.ScriptLoad', manifest.id, manifest.alias);
                ...
                return extension
                    ...
                    .catch(function (e) {
                    error_1 = new Error(sp_core_library_1.Text.format(strings.extensionInitFailure, componentId));
                    qosMonitor.writeExpectedFailure('ExtensionInitFailure', error_1, extraData);
                    throw error_1;
                });
            }, function (e) {
                if (!error_1) {
                    error_1 = new Error(sp_core_library_1.Text.format(strings.extensionLoadFailure, componentId));
                ...
                sp_telemetry_1._PerformanceLogger.logPerformanceMetricToConsole(perfLogKeyScriptLoad_1, 'Extension.Create', manifest.id, manifest.alias);
            ...
            var fabricLoadingPromise = sp_component_base_1._LegacyThirdPartyFabricCoreLoader.forceLoad(manifest);
            fabricLoadingPromise.catch(function (e) {
                return sp_diagnostics_1._TraceLogger.logError(ExtensionManager._logSource, new Error("Failed to load legacy fabric core styles: ".concat(e)));
            });
    ...
    ExtensionManager.prototype.disposeExtensions = function () {
        for (var _i = 0, _a = this._extensions; _i < _a.length; _i++) {
            ...
            try {
                ...
                sp_diagnostics_1._TraceLogger.logError(ExtensionManager._logSource, new Error("Failed to dispose extension \"".concat(manifest.alias, "\"\n            + \" with id=").concat(manifest.id, ": ") + e.message));
            }
        }
        this._extensions = [];
    };
    ...
    ExtensionManager.prototype._createQosExtraData = function (manifest) {
        ...
        qosExtraData.teamsHosted = sp_core_library_1._BrowserUtilities.isTeamsHosted();
        return qosExtraData;
    };
    ExtensionManager._logSource = sp_diagnostics_1._LogSource.create('ExtensionManager');
