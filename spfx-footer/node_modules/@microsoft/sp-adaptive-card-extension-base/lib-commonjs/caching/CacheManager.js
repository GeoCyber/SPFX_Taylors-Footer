...
var LocalStorageACECache_1 = require("./cache/LocalStorageACECache");
var CacheManager = /** @class */ (function () {
    ...
    CacheManager.prototype.save = function (instanceId, currentCardView, renderParameters, cardNavigatorState, cachedState) {
        var _a, _b;
        var cacheObject;
        if (this._settings.isEnabled) {
            ...
            if ((customCacheCardView && customCacheCardView.isCacheEnabled) ||
                ...
                (_a = this._context._host.cache) === null || _a === void 0 ? void 0 : _a.save(LocalStorageACECache_1.LocalStorageACECache.getKey(this._context.pageContext.site.id.toString(), (_b = this._context.pageContext.listItem) === null || _b === void 0 ? void 0 : _b.uniqueId), instanceId, cacheObject);
            }
        }
        return cacheObject;
    };
