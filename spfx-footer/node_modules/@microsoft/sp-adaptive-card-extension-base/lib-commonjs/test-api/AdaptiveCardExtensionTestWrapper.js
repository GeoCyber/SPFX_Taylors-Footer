...
var AdaptiveCardExtensionTestWrapper = /** @class */ (function () {
    function AdaptiveCardExtensionTestWrapper(_testData, _cls, rootScope) {
        var _this = this;
    ...
    AdaptiveCardExtensionTestWrapper.prototype.load = function () {
        ...
        this._adaptiveCardExtension._internalInitialize(this._getContext(this._testData), false, sp_core_library_1.DisplayMode.Read, TEST_TAG_NAME);
