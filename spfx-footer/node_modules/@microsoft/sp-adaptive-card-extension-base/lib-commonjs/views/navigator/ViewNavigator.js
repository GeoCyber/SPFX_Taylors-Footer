...
var BaseAdaptiveCardView_1 = require("../quickView/BaseAdaptiveCardView");
...
}(BaseAdaptiveCardView_1.BaseAdaptiveCardView));
/**
...
var ViewNavigator = /** @class */ (function () {
    function ViewNavigator(_handleStackChangedCallback, _handleInitializeCallback) {
        this._handleStackChangedCallback = _handleStackChangedCallback;
    ...
    ViewNavigator.prototype._push = function (id) {
        ...
        if (cachedView === undefined) {
            ...
            if (!(0, Killswitches_1.isAsyncQuickViewKSActivated)() && view instanceof Promise) {
