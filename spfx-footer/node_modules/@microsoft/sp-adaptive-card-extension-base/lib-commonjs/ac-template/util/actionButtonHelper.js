...
exports.updateExternalLinkTeamsDeepLinkTarget = exports.updateSubmitActionButtonType = exports.createAction = exports.appendActions = void 0;
...
function appendActions(template, buttons, size, deviceContext) {
    var actions = [];
    ...
    for (var i = 0; i < limit; i++) {
        ...
        var actionId = cardButton.id ? cardButton.id : "ac-button-".concat(i);
...
function createAction(deviceContext, buttonType, actionId, title, style) {
    ...
    if (buttonType.type === 'Submit') {
        ...
        if (!url || url === '') {
            throw new Error(sp_core_library_1.Text.format(strings.TargetUrlIsUndefinedOrEmpty, actionId));
        }
        cardAction = {
            id: actionId,
            type: 'Action.OpenUrl',
    ...
    else if ((0, Flights_1.isWexVivaUploadActionEnabled)() && buttonType.type === 'VivaAction.SelectMedia') {
    ...
    else if ((0, Flights_1.isWexVivaLocationSupportEnabled)() && buttonType.type === 'VivaAction.GetLocation') {
        var parameters = buttonType.parameters;
        cardAction = {
            id: actionId,
    ...
    else if ((0, Flights_1.isWexVivaLocationSupportEnabled)() && buttonType.type === 'VivaAction.ShowLocation') {
        var parameters = buttonType.parameters;
        cardAction = {
            id: actionId,
...
function _isValidMSTeamsDeviceContext(deviceContext) {
    if (!(0, Killswitches_1.isCreateMSTeamsDeepLinkForVCDKSActivated)()) {
        return deviceContext !== 'Mobile';
    }
    else {
        return deviceContext === 'WebView';
    }
}
