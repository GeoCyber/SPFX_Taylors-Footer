...
var IsolatedAdaptiveCardExtensionService = /** @class */ (function () {
    function IsolatedAdaptiveCardExtensionService(_serviceScope) {
        ...
        this._handleIsolatedApplicationMessage = function (message) {
            ...
            if (data.messageType === 'applicationMessage') {
                ...
                var configurableTokenProvider = sp_http_1._AadTokenProviders.configurable;
    ...
    IsolatedAdaptiveCardExtensionService.prototype.load = function (args) {
        ...
        if (!isolatedFrame) {
            ...
            var isVCD1P_1 = sp_core_library_1._BrowserUtilities.isTeams1PVivaDesktopHosted(sp_diagnostics_1._QosMonitor);
            if (isVCD1P_1 && (0, Flights_1.isFramedTeamsLogonEnabled)()) {
            ...
            if (!(0, Killswitches_1.isIsolatedTABTestKSActivated)()) {
