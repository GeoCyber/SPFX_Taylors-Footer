...
var NavigationOrchestrator = /** @class */ (function () {
    ...
    NavigationOrchestrator.prototype.navigate = function (preloadedData) {
        ...
        if (isSameApp &&
            appLoaded &&
            currentAppId.equals(sp_core_library_1.Guid.tryParse(NavigationOrchestrator.spListHostComponentId))) {
        ...
        if (!Killswitches_1.Killswitches.isClearEventQueueKSActivated()) {
        ...
        if (window['__spfxMark'] // tslint:disable-line:no-string-literal
        ) {
        ...
        if (NavigationOrchestrator.spListHostComponentId !== preloadedData.clientSideApplicationId) {
    ...
    NavigationOrchestrator.prototype._loadApplicationCustomizers = function (preloadedData) {
        if (this._appSupportsExtensions(preloadedData)) {
            sp_diagnostics_1._TraceLogger.logVerbose(NavigationOrchestrator._logSource, 'Loading application customizers');
            return this._applicationCustomizerLoader.loadExtensions(preloadedData.customActions);
        }
        else {
            sp_diagnostics_1._TraceLogger.logVerbose(NavigationOrchestrator._logSource, 'Application Customizer is not supported for classic pages and workbench.');
            return Promise.resolve();
        }
    };
    /**
    ...
    NavigationOrchestrator.prototype._updateTelemetry = function (preloadedData) {
        ...
        var manifestAlias = preloadedData && preloadedData.manifests && preloadedData.manifests.length > 0
            ...
            : '';
        var contextInfo;
        var _g = this._pageContext.legacyPageContext, isHubSite = _g.isHubSite, webTemplate = _g.webTemplate, hubSiteId = _g.hubSiteId, isEduClass = _g.isEduClass;
        var pageType;
        var promotedState;
        var pageId;
        ...
        var workloadName = !Killswitches_1.Killswitches.isChangeWorkloadForTeamsWorkBenchKSActivated() &&
            ...
            ? 'TeamsWorkBench'
            : manifestAlias;
        var isAriaTokenKSActivated = sp_core_library_1._SPKillSwitch.isActivated('4ece3b19-59df-4f7d-a576-60c7c2f0f088'
        /* '01/19/2022', 'Use Aria Tokens for sp-list-host app' */
        );
        if (!isAriaTokenKSActivated) {
        ...
        sp_diagnostics_1._Diagnostics.updateSettings({
            siteId: this._pageContext.site.id.toString(),
            webId: this._pageContext.web.id.toString(),
            listId: ((_e = this._pageContext.list) === null || _e === void 0 ? void 0 : _e.id.toString()) || '',
            listItemUniqueId: ((_f = this._pageContext.listItem) === null || _f === void 0 ? void 0 : _f.id.toString()) || '',
            correlationId: this._pageContext.site.correlationId.toString(),
    ...
    NavigationOrchestrator._logSource = sp_diagnostics_1._LogSource.create('NavigationOrchestrator');
