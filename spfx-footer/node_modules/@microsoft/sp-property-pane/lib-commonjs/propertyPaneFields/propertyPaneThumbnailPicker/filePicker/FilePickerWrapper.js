...
var interfaces_1 = require("office-ui-fabric-react/lib/utilities/selection/interfaces");
...
var strings = tslib_1.__importStar(require("./FilePickerWrapperStrings.resx"));
...
var FilePickerWrapper = /** @class */ (function () {
    ...
    FilePickerWrapper.prototype._ensureFilePickerAsync = function () {
        if (!this._filePicker) {
            var filePickerData = {
                ...
                selectionMode: this._options.isMultiSelectMode ? interfaces_1.SelectionMode.multiple : interfaces_1.SelectionMode.single,
    ...
    /* event this is defined as a string actually   */
