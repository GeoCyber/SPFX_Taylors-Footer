...
var SearchBox_1 = require("office-ui-fabric-react/lib/components/SearchBox/SearchBox");
...
var strings = tslib_1.__importStar(require("./IconPickerStrings.resx"));
...
var IconPicker = /** @class */ (function (_super) {
    ...
    function IconPicker(props) {
        ...
        _this._handleSearchChange = function (_event, value) {
    ...
    IconPicker._getFabricMDL2IconNames = function () {
        ...
        return Object.keys(iconSettings).filter(function (iconName) {
            ...
            return (IconPicker._excludedIcons.indexOf(iconName) === -1 &&
                ...
                iconRecord.subset.fontFace.fontFamily.indexOf(FABRIC_MDL2_ICONS_FONT_NAME) > -1);
        });
    };
    IconPicker.prototype.UNSAFE_componentWillUpdate = function (nextProps, nextState) {
        ...
        if (nextState.isOpen === true && this.state.isOpen === false) {
            (_a = this.state.screenReaderAlert) === null || _a === void 0 ? void 0 : _a.read(strings.IconPickerInstructionMessage, sp_component_utilities_1.ReadingMode.ReadImmediately);
        }
    };
    ...
    IconPicker.prototype.render = function () {
        ...
        return (React.createElement(Panel_1.Panel, { className: IconPicker_module_scss_1.default.panel, elementToFocusOnDismiss: this.props.elementToFocusOnDismiss, isLightDismiss: true, isOpen: this.state.isOpen, onDismiss: this._handleCancel, type: Panel_1.PanelType.extraLarge },
            React.createElement("div", { className: (0, office_ui_fabric_react_bundle_1.css)(IconPicker_module_scss_1.default.panelHeader, IconPicker_module_scss_1.default.fluent) },
                React.createElement("div", { className: panelTitleClassName }, strings.PanelTitle),
                React.createElement(SearchBox_1.SearchBox, { className: IconPicker_module_scss_1.default.searchBox, onChange: this._handleSearchChange, placeholder: strings.SearchBoxPlaceholderText, value: this.state.searchInput, clearButtonProps: { ariaLabel: strings.ClearButtonAriaLabel } })),
            ...
            React.createElement("div", { className: IconPicker_module_scss_1.default.actionButtonsContainer },
                React.createElement("div", { className: IconPicker_module_scss_1.default.actionButtons },
                    React.createElement(office_ui_fabric_react_bundle_1.PrimaryButton, { className: IconPicker_module_scss_1.default.actionButton, disabled: isSaveDisabled, onClick: this._handleSave }, strings.SaveButtonText),
                    React.createElement(office_ui_fabric_react_bundle_1.DefaultButton, { className: IconPicker_module_scss_1.default.actionButton, onClick: this._handleCancel }, strings.CancelButtonText))),
            screenReaderAlert));
    };
