...
var PropertyPane = /** @class */ (function (_super) {
        ...
        var fabricWrapper = (React.createElement(office_ui_fabric_react_bundle_1.Fabric, { "data-sp-feature-tag": 'Property Pane', "data-sp-feature-instance-id": '_Property Pane' },
            ...
            React.createElement(office_ui_fabric_react_bundle_1.FocusTrapZone, { isClickableOutsideFocusTrap: true, forceFocusInsideTrap: false, disabled: this.props.data.configuration.disableFocusTrap },
                React.createElement("div", { className: this.props.renderNarrow
                        ...
                        : PropertyPane_module_scss_1.default.propertyPane, role: 'region', "aria-label": sp_core_library_1.Text.format(strings.UpdatedPropertyPaneAriaLabel, this.props.data.title), "aria-describedby": this._descriptionId, ref: this._propertyPane, onKeyDown: this._onPropertyPaneKeyDown, key: this.props.data.webPartId },
                    showOverlaySpinner && (React.createElement(office_ui_fabric_react_bundle_1.Overlay, { className: PropertyPane_module_scss_1.default.overlay },
                        React.createElement(office_ui_fabric_react_bundle_1.Spinner, { className: PropertyPane_module_scss_1.default.spinner, type: office_ui_fabric_react_bundle_1.SpinnerType.large, label: strings.PropertyPaneFetchingSettingsDataLabel }))),
                    React.createElement(PropertyPaneTitleBar_1.PropertyPaneTitleBar, { title: this.props.data.title, onClose: this._handleCloseClick }),
                    React.createElement("div", null, this._shouldRenderEmptyPage ? this._renderNoConfigurationState() : this._renderPage())))));
        return (React.createElement(React.Fragment, null,
            isFluentVNextThemeEnabled && React.createElement(VNextThemeWrapper_1.VNextThemeWrapper, null, fabricWrapper),
    ...
    PropertyPane.prototype._renderPage = function () {
        ...
        return (React.createElement("div", null,
            React.createElement("div", { className: (0, office_ui_fabric_react_bundle_1.css)(classForPropertyPanePageContentBottom, PropertyPanePage_module_scss_1.default.propertyPanePageContent), "data-automation-id": 'propertyPanePageContent' },
                React.createElement("div", null, this.props.children),
