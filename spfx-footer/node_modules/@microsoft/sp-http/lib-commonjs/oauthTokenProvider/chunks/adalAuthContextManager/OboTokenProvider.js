...
var OboTokenProvider = /** @class */ (function () {
    ...
    OboTokenProvider.prototype._getAccessToken = function (resourceEndpoint, useCachedToken) {
        var _this = this;
        if (!sp_core_library_1._SPKillSwitch.isActivated('429e2082-7017-4a21-b6bd-cea135547e53'
        /*'03/22/2022',
        'Cache token fetching via obo'*/
        ) &&
            useCachedToken) {
    ...
    OboTokenProvider.prototype._fetchAccessToken = function (resourceEndpoint) {
        ...
        this._cachedTokens.set(resourceEndpoint, this._fetchAccessTokenSilent(resourceEndpoint, extraLogData)
            .then(function (token) {
            acquireAccessTokenQosMonitor.writeSuccess();
            return token;
        })
