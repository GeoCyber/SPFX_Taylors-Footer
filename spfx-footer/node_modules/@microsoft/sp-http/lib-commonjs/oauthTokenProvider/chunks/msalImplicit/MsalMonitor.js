 ...
 * to true.
 *
 * TODO: This can also be used by MsalTokenProvider.
 *
 * @internal
 */
...
var MsalMonitor = /** @class */ (function () {
    function MsalMonitor(scenarioName, shouldSkipLogging) {
        ...
        this.shouldSkipLogging = shouldSkipLogging;
        if (!shouldSkipLogging) {
            this.qosMonitor = new sp_diagnostics_1._QosMonitor(scenarioName);
        }
    }
    /**
    ...
    MsalMonitor.prototype.writeSuccess = function (extraData) {
        ...
        (_a = this.qosMonitor) === null || _a === void 0 ? void 0 : _a.writeSuccess(extraData);
    };
    /**
    ...
    MsalMonitor.prototype.writeExpectedFailure = function (tagNameSuffix, error, extraData) {
        ...
        (_a = this.qosMonitor) === null || _a === void 0 ? void 0 : _a.writeExpectedFailure(tagNameSuffix, error, extraData);
    };
    /**
    ...
    MsalMonitor.prototype.writeUnexpectedFailure = function (tagNameSuffix, error, extraData) {
        ...
        if ((browserInfo === null || browserInfo === void 0 ? void 0 : browserInfo.browser) === sp_core_library_1._Browser.IE) {
            ...
            (_b = this.qosMonitor) === null || _b === void 0 ? void 0 : _b.writeUnexpectedFailure(tagNameSuffix, error, extraData);
        }
    };
    return MsalMonitor;
}());
