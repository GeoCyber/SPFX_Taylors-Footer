...
var MsalTokenProvider = /** @class */ (function () {
    ...
    MsalTokenProvider.prototype.getTokenData = function (resourceEndpoint, useCachedToken, skipLoggingAndDisableRedirects) {
        ...
        if ((0, AadFlights_1.isMsalBrowserFlightEnabled)()) {
            return this.getTokenDataV2(resourceEndpoint, useCachedToken, skipLoggingAndDisableRedirects);
        }
     ...
     */
    MsalTokenProvider.prototype.getTokenDataV2 = function (resourceEndpoint, useCachedToken, skipLoggingAndDisableRedirects) {
        var _this = this;
        if (useCachedToken === void 0) { useCachedToken = true; }
        if (skipLoggingAndDisableRedirects === void 0) { skipLoggingAndDisableRedirects = false; }
        return MsalInteractionManager_1.MsalInteractionManager.acquireControl().then(function () {
            ...
            if (currentBrowser === sp_core_library_1._Browser.IE || currentBrowser === sp_core_library_1._Browser.Edge) {
                ...
                acquireTokenDataPromise = _this._acquireTokenData(resourceEndpoint, skipLoggingAndDisableRedirects);
            }
    ...
    MsalTokenProvider.prototype._initializeMsalJs = function () {
        ...
        if (MsalUtilities_1.MsalUtilities.shouldPrintMsalLogsToConsole()) {
            configuration.system.logger = new msalLegacy.Logger(MsalUtilities_1.MsalUtilities.msalLoggerCallback, {
