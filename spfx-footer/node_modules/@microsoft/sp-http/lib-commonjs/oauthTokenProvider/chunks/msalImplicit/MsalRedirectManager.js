...
var MsalRedirectManager = /** @class */ (function () {
    ...
    MsalRedirectManager.prototype.hasRedirectAttemptsLeft = function () {
        return this.getNumberOfRedirectAttemptsInLastMinute() < MsalRedirectManager._ALLOWED_REDIRECT_ATTEMPTS;
    };
    /**
    ...
    MsalRedirectManager.prototype.isRedirectInProgress = function () {
        ...
        var isRedirectAttemptInLastMinute = this.getNumberOfRedirectAttemptsInLastMinute() > 0;
    ...
    /**
     * Determines the number of redirect attempts in the last minute using storage states.
     *
     * @returns The number of redirects in the last minute.
     */
    MsalRedirectManager.prototype.getNumberOfRedirectAttemptsInLastMinute = function () {
        ...
        if (firstRedirectTime) {
            ...
            var hasLessThanOneMinutePassedSinceFirstRedirect = now.getTime() - firstRedirectDate.getTime() < oneMinuteInMs;
            if (hasLessThanOneMinutePassedSinceFirstRedirect) {
    ...
    MsalRedirectManager.prototype._incrementRedirectAttempts = function () {
        var currentRedirectAttempt = this.getNumberOfRedirectAttemptsInLastMinute() + 1;
