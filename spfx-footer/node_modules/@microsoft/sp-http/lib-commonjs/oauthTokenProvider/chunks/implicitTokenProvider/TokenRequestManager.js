...
var TokenRequestManager = /** @class */ (function () {
    ...
    TokenRequestManager.prototype.getToken = function (resourceUri, useLoginHint) {
        ...
        var tokenRequest = this._getToken(resourceUri, useLoginHint, resourceMetadata, 0);
        return tokenRequest;
    };
        ...
        return tokenRequest
            ...
            if (TokenRequestManager.isSuccessfulResponse(response)) {
                ...
                if (attemptCount < 1) {
                    ...
                    if (response.errorDescription.indexOf(AadConstants_1.default.LOGIN_REQUIRED) > -1) {
