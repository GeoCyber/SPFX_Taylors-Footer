...
var DeferredAadTokenProvider = /** @class */ (function () {
    ...
    DeferredAadTokenProvider.prototype._getTokenInternal = function (resourceEndpoint, configuration, useCachedToken) {
        ...
        if (this._shouldUseOboTokenExchange() && this._oboConfiguration) {
            ...
            getTokenPromise = this._getOboTokenProvider(tokenProviderConfig, this._oboConfiguration, this._oboFirstPartyTokenCallback, this._oboThirdPartyTokenCallback).then(function (tokenProvider) { return _this._getToken(tokenProvider, resourceEndpoint, useCachedToken); });
        }
    ...
    DeferredAadTokenProvider.prototype._shouldUseMsalTokenProvider = function (configuration) {
        ...
        var shouldUseMsalTokenProvider = isAadSessionIdValidGuid;
    ...
    DeferredAadTokenProvider.prototype._getMsalBrowserTokenProvider = function (configuration) {
        var _this = this;
        return Promise.resolve().then(function () { return tslib_1.__importStar(require('../msalImplicit/msalBrowser/MsalBrowserTokenProvider' /* webpackChunkName: 'msalBrowser' */)); }).then(function (msalBrowserTokenProviderModule) {
