...
var CacheManager = /** @class */ (function () {
     ...
     */
    CacheManager.fetchAndCache = function (cacheKey /* tslint:disable-line:no-any */, cacheProvider, cacheConfiguration, serverFetch, prefetchProvider) {
    ...
    CacheManager._applyCacheThenNetworkStrategy = function (cacheKey /* tslint:disable-line:no-any */, cacheProvider, cacheConfiguration, serverFetch, prefetchProvider) {
        var _a;
        ...
        var setServerResponse = function () {
        ...
        return cacheProvider
            ...
            if ((_a = cacheData.stats) === null || _a === void 0 ? void 0 : _a.isStale) {
                ...
                qosAlias = 'CacheFromFreshDataFlush';
            }
            qosMonitor.writeSuccess({ alias: qosAlias });
    ...
    CacheManager._getServerData = function (cacheKey /* tslint:disable-line:no-any */, cacheProvider, cacheConfiguration, serverFetch, prefetchProvider, qosMonitor, qosAliasPrefix) {
        ...
        var freshFlushedData = !!prefetchProvider
            ? prefetchProvider.getDataAsync(cacheKey.key, {
                ...
                if (freshData) {
                    ...
                    setTimeout(function () { return cacheProvider.setData(cacheKey, freshData.data, cacheConfiguration); }, 0);
    ...
    CacheManager._applySimpleCacheThenNetworkStrategy = function (cacheKey /* tslint:disable-line:no-any */, cacheProvider, cacheConfiguration, serverFetch) {
        var cachableResponse = {
            cachedResponse: undefined,
            serverResponse: undefined
        };
