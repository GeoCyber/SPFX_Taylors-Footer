...
var ManifestProvider = /** @class */ (function () {
    function ManifestProvider(serviceScope, _webAbsoluteUrl, buildNumber) {
    ...
    ManifestProvider.prototype.fetchManifests = function (requests) {
        ...
        return this._httpClient
            .post("".concat((this._pageContext.web && this._pageContext.web.absoluteUrl) || this._webAbsoluteUrl, "/_api/web/GetClientSideComponents"), sp_http_1.SPHttpClient.configurations.v1, tslib_1.__assign({ body: JSON.stringify(body) }, (!(0, killSwitches_1.isVersionHeaderKillSwitchActivated)() && {
            headers: {
