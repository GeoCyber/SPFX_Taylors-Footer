...
export declare class _CumulativeManifestProcessor {
     ...
     */
    generateCumulativeManifest(debugManifests: IClientSideComponentManifest[], manifestsJsFileMetadata: _IManifestsFileMetadata | undefined): Promise<void>;
    reset(): void;
...
export declare class _ManifestsFileBuilder {
    ...
    buildManifestsJs(manifestsArray: IClientSideComponentManifest[], outputFilePath: string, azurePathOverride: string | undefined, manifestsJsFileMetadata: _IManifestsFileMetadata | undefined): Promise<void>;
