...
exports.default = (0, LoaderFactory_1.loaderFactory)(function (locFilePath, content, options) {
    const locFileData = LocFileParser_1.LocFileParser.parseLocFile(Object.assign(Object.assign({}, options), { content, filePath: locFilePath, terminal: new node_core_library_1.Terminal(LoaderTerminalProvider_1.LoaderTerminalProvider.getTerminalProviderForLoader(this)) }));
    const resultObject = {};
