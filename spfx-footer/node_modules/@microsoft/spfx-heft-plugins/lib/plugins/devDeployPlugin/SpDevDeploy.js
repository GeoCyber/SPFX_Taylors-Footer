...
class SpDevDeploy {
    ...
    static getDevDeployContainerDirectoryName() {
        return (0, getDevDeployContainerDirectoryName_1.getDevDeployContainerDirectoryName)();
    }
    ...
    async getFiles() {
        ...
        await manifestsFileBuilder.buildManifestsJs(manifestsArray, manifestsFileFullPath, undefined, this._options._manifestsJsFileMetadata);
        filesToUpload.push({
