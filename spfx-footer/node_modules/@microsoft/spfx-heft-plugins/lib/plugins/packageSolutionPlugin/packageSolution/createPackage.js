...
function createPackage(terminal, config, manifests) {
    ...
    try {
        ...
        return (0, readCustomFeatures_1.default)(terminal, config).then((customFeatures) => {
            terminal.writeLine(node_core_library_1.Colors.green('Done!'));
            terminal.writeLine();
            ...
            return (0, readResources_1.default)(terminal, config).then((resources) => {
                terminal.writeLine(node_core_library_1.Colors.green('Done!'));
                terminal.writeLine();
                terminal.writeLine(node_core_library_1.Colors.yellow('Reading Sharepoint Assets & Creating XML...'));
                const solutionXml = (0, createSolutionXml_1.default)(terminal, config.solution, customFeatures.customFeatureFilepath, resources, config.contentTypes);
                terminal.writeLine(node_core_library_1.Colors.green('Done!'));
                terminal.writeLine();
                ...
                return (0, writePackage_1.default)(terminal, solutionXml, config).then(() => {
                    terminal.writeLine(node_core_library_1.Colors.green('Done!'));
                    terminal.writeLine();
