...
function createSolutionXml(terminal, solution, customFeatureFilenames, resources, contentTypes) {
    ...
    const relationshipsXml = (0, createRelationshipsXml_1.default)('', [
        {
    ...
    const featuresXml = solution.features.map((feature) => (0, createFeatureXml_1.default)(terminal, feature, resources));
    ...
    if (includeClientAssets) {
        ...
        const clientSideFeatureXml = (0, createFeatureXml_1.default)(terminal, clientSideAssetsFeature, {
    ...
    const icon = solution.iconPath ? (0, createIcon_1.default)(solution.iconPath) : undefined;
    ...
    manifestXml.relationships = (0, createRelationshipsXml_1.default)(constants_1.default.appManifestFileName, relsList);
    return {
