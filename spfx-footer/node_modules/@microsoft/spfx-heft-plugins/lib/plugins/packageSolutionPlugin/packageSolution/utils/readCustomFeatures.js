...
function getCustomFeatureXmlFilenames(terminal, featureXmlDir) {
    return (0, getFiles_1.getRelativeFilePaths)(terminal, path.join(featureXmlDir, constants_1.default.RelsFolder), `*${constants_1.default.RelsXml}`, 'Found custom feature file: ').then((filenames) => {
...
function getCustomFiles(terminal, featureXmlDir) {
    return (0, getFiles_1.getFiles)(terminal, featureXmlDir, '**/*.*', 'Found custom file: ');
}
