...
class CumulativeManifestProcessor {
     ...
     */
    async generateCumulativeManifest(debugManifests, manifestsJsFileMetadata) {
        if (!this._options) {
        ...
        await manifestsFileBuilder.buildManifestsJs(manifestsArray, path.join(this._options.rootPath, this._options.tempFolderName, `${CUMULATIVE_MANIFEST_FILENAME}.js`), undefined, manifestsJsFileMetadata);
    }
    reset() {
