...
var URL = /** @class */ (function (_super) {
        ...
        get: function () {
            if (SPECIAL_SCHEMES_AND_PORTS.hasOwnProperty(this.protocol)) {
                if (!this.port || SPECIAL_SCHEMES_AND_PORTS[this.protocol] === this.port) {
                    ...
                    return "".concat(this.protocol, "//").concat(this._innerAnchorElement.hostname);
                }
                else {
                    // Non-standard port, serialize the port
                    return "".concat(this.protocol, "//").concat(this._innerAnchorElement.hostname, ":").concat(this.port);
                }
            }
            else {
                return 'null';
    ...
    Object.defineProperty(URL.prototype, "protocol", {
        ...
        set: function (newValue) {
            ...
            if (protocolMatches) {
                this._invalidate();
                this._innerAnchorElement.protocol = "".concat(protocolMatches[1], ":");
            }
        },
        enumerable: false,
        configurable: true
