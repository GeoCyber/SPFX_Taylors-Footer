...
var URL = /** @class */ (function (_super) {
    ...
    Object.defineProperty(URL.prototype, "protocol", {
        get: function () {
            return "".concat(this._parsedUrl.scheme, ":");
        },
        set: function (newValue) {
            // Trim the trailing ":" and serialize "null" or "undefined" as a weird caveat of the spec
            var protocolMatches = "".concat(newValue).match(/^([^\:]+):?$/);
            if (protocolMatches) {
                this._invalidate();
                usm.basicURLParse("".concat(protocolMatches[1], ":"), { url: this._parsedUrl, stateOverride: 'scheme start' });
            }
        },
        enumerable: false,
        configurable: true
    ...
    Object.defineProperty(URL.prototype, "username", {
        ...
        set: function (newValue) {
            ...
            if (!usm.cannotHaveAUsernamePasswordPort(this._parsedUrl)) {
                ...
                usm.setTheUsername(this._parsedUrl, "".concat(newValue));
            }
        },
        enumerable: false,
        configurable: true
    ...
    Object.defineProperty(URL.prototype, "host", {
        get: function () {
            if (!this._parsedUrl.host) {
                ...
                return "".concat(usm.serializeHost(this._parsedUrl.host), ":").concat(usm.serializeInteger(this._parsedUrl.port));
            }
        },
        set: function (newValue) {
    ...
    Object.defineProperty(URL.prototype, "pathname", {
        get: function () {
            if (this._parsedUrl.cannotBeABaseURL) {
                ...
                return "/".concat(this._parsedUrl.path.join('/'));
            }
        },
        set: function (newValue) {
            if (!this._parsedUrl.cannotBeABaseURL) {
    ...
    Object.defineProperty(URL.prototype, "hash", {
        get: function () {
            if (!this._parsedUrl.fragment) {
                ...
                return "#".concat(this._parsedUrl.fragment);
            }
        },
        set: function (newValue) {
            this._invalidate();
            // Trim the leading "#" and serialize "null" or "undefined" as a weird caveat of the spec
            var fragmentMatches = "".concat(newValue).match(/^#?(.*)/);
    ...
    Object.defineProperty(URL.prototype, "_query", {
        get: function () {
            ...
            if (this._parsedUrl.query) {
                return "?".concat(this._parsedUrl.query);
            }
            else {
