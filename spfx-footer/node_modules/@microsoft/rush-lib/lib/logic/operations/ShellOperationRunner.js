            ...
            if (this._buildCacheConfiguration && this._buildCacheConfiguration.buildCacheEnabled) {
                ...
                if (projectConfiguration) {
                    ...
                    if (projectConfiguration.disableBuildCacheForProject) {
                        ...
                        if (operationSettings === null || operationSettings === void 0 ? void 0 : operationSettings.disableBuildCacheForOperation) {
                            terminal.writeVerboseLine(`Caching has been disabled for this project's "${this._commandName}" command.`);
                        }
                        else {
                            const projectOutputFolderNames = (operationSettings === null || operationSettings === void 0 ? void 0 : operationSettings.outputFolderNames) || [];
